...
1. Install dependencies
   ...
   The thesis depends on several latex packages. Check the 'dependence_texlive' target in Makefile for the package list.
   If using TexLive, you can run the 'tlmgr install .....' command in Makefile to install the required packages. Note that TexLive installed via `apt install` in Ubuntu gives an unusable `tlmgr`, and one good solution is to uninstall it and reinstall TexLive via the tool in https://tug.org/texlive/quickinstall.html.
